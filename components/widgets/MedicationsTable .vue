...
export default {
  ...
  data() {
    return {
      ...
      fields: [
        ...
        {
          key: "attributes.Producto",
          label: "Producto",
          sortable: true,
        },
        {
          label: "Plagas",
          key: "attributes.Plagas",
          sortable: true,
        },
        {
          label: "Acaros Antes",
          key: "attributes.AcarosAntes",
          sortable: true,
        },
  ...
  computed: {
    tasks() {
      let totaltasks = this.$store.getters.readMedications;
          ...
          <b-table table-class="table table-centered datatable table-card-list" thead-tr-class="bg-transparent"
            ...
            <template v-slot:cell(attributes.Slug)="data">
              <div class="custom-control custom-checkbox ">
                <NuxtLink :to="{
                  path: '/medication/' + data.item.attributes.Slug,
