...
export default {
  ...
  data() {
    return {
      ...
      fields: [
        ...
        {
          key: "attributes.Nucleo",
          label: "Nucleos",
          sortable: true,
        },
        {
          key: "attributes.Enjambre",
          label: "Enjambres",
  ...
  computed: {
    tasks() {
      let totaltasks = this.$store.getters.readCompositions;
          ...
          <b-table table-class="table table-centered datatable table-card-list" thead-tr-class="bg-transparent"
            ...
            <template v-slot:cell(attributes.Slug)="data">
              <div class="custom-control custom-checkbox ">
                <NuxtLink :to="{
                  path: '/composition/' + data.item.attributes.Slug,
            ...
            <template #cell(attributes.Mes)="data">
