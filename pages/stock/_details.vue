    ...
    computed: {
        stock() {
            ...
            if (this.$store.getters.readStocks != "") {
                let result = this.$store.getters.readStocks.find(
                    ...
                    <div class="card-body">
                        <div class="invoice-title">
                            ...
                            <div class="text-muted">
                                ...
                                <p class="mb-1"><b>Apiario:</b> {{ stock.NombreApiario }}</p>
                                <p class="mb-1"><b>Fecha:</b> {{ formatFecha(stock.Fecha) }}</p>
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="text-muted">
                                    <h5 class="font-size-16 mb-3">Material:</h5>
                                    <p >{{ stock.Material }}</p>

                                </div>
                                <div class="text-muted">
                                    <h5 class="font-size-16 mb-3">Costo:</h5>
                                    <p >₡{{ stock.Costo }}</p>

                                </div>
                                <div class="text-muted">
                                    <h5 class="font-size-16 mb-3">Cantidad:</h5>
                                    <p >{{ stock.Cantidad }}</p>
                            ...
                            <div class="col-sm-6">
                                <div class="text-muted text-sm-right">
                                    <div>
                                        <h5 class="font-size-16 mb-1">Totales:</h5>
                                        <p>{{ stock.Total }}</p>
                                    </div>
                                    <div class="mt-4">
                                        <h5 class="font-size-16 mb-1">Faltantes:</h5>
                                        <p>{{ stock.MaterialesFaltantes }}</p>
                                    </div>
                                </div>
                            </div>
                        </div>
