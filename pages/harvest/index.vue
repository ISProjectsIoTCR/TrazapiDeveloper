...
import HarvestTable from '../../components/widgets/HarvestsTable.vue';

export default {
  middleware: ['authenticated'],
  head() {
    return {
      title: `Control Actividades Precosecha y Cosecha`
    };
  },
  components: {
    DatePicker,
  ...
  data() {
    return {
      ...
      actividad: [
        { name: "Mantenimiento del apiario" },
        { name: "Alzas colocadas" },
        { name: "Fusión de Colmenas" },
        { name: "Cambio de panales" },
        { name: "Retiro de cajas de colmenas que evadieron" },
        { name: "Revision y mantenimiento de equipos de extraccion" },
        { name: "Monitoreo de enfermedades" },
        { name: "Monitoreo de Varroa" },
        { name: "Tratamiento de Varroa" },
        { name: "% de infestación" },
        { name: "Actividades a realizar" },
        { name: "Alambrar panales" },
        { name: "Laminado de panales" },
        { name: "Desinfección de cajas y fondos" },
        { name: "Preparación de estañones" },
        { name: "Otros" }
      ],
      selectedActividad: "",
      submitted: false,
      ...
      items: {
        text: "CONTROL PRECOSECHA Y COSECHA",
        href: "/"
      },
    };
  },
        ...
        if (this.newtask.acepta) {
          ...
          await this.$apollo
            .mutate({
              ...
              mutation: require("../../graphql/createHarvest.gql"),
            ...
            .then((data) => {
              ...
              this.$store.dispatch("getHarvests");
